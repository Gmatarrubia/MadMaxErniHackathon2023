...
def updateValues():
    ...
    while True:
        try:
            ...
            sensorValuesStr = ','.join(map(str, sensorValues))
            with open("/home/madmax/ErniHackathon2023/RobotServices/component/sensorLine/data.txt", "w") as file:
                file.write(sensorValuesStr)
